...
# MAGIC %md
# MAGIC ## Experiment, train and log with MLFLow
...
# MAGIC   
# MAGIC ## Requirements
# MAGIC * If you are using a cluster running Databricks Runtime, you must install MLflow. 
...
# if not using cluster mlflow as cluster lib run: %pip install mlflow
...
# MAGIC %md ## Name the experiment in WS and set location for artifacts

# COMMAND ----------

# Name location in WS of experiment
experiment_name = "/Shared/experiments/diabetes_20220215"
# Artifact location (custom)
if not mlflow.get_experiment_by_name(experiment_name):
  mlflow.create_experiment(experiment_name, "dbfs:/modeltrackingmh/diabetes20220215")
# Set mlflow to use this experiment
...
# MAGIC %sh
# MAGIC less /dbfs/modeltrackingmh/diabetes20220215/manualsave/model-0.010000-0.500000/requirements.txt

# COMMAND ----------

# MAGIC %sh
# MAGIC less /dbfs/modeltrackingmh/diabetes20220215/manualsave/model-0.010000-0.500000/conda.yaml
